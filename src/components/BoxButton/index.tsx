		...
		<>
			<div
				...
				{img ? (
					...
					<div className="flex items-center text-center justify-center w-full h-full bg-box hover:text-textColor duration-300 hover:bg-details rounded-t-xl text-3xl mobile:text-xl font-semibold">
						{title}
					</div>
				)}
